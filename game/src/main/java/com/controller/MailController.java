...
public class MailController extends BaseController {
    ...
    // 邮件列表
    public MAIL_MSG.STC_MAIL_LIST mailList(Player player, MAIL_MSG.CTS_MAIL_LIST req) {
        MAIL_MSG.STC_MAIL_LIST.Builder builder = MAIL_MSG.STC_MAIL_LIST.newBuilder();
    ...
    //领取邮件
    public MAIL_MSG.STC_RECEIVE_ITEMS receiveItems(Player player, MAIL_MSG.CTS_RECEIVE_ITEMS req) throws StatusException {
        MAIL_MSG.STC_RECEIVE_ITEMS.Builder builder = MAIL_MSG.STC_RECEIVE_ITEMS.newBuilder();
